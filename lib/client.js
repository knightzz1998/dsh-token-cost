			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsx)(primitives.Tooltip, {
						label: model !== null ? `${symbol}${amount} · ${model}` : `${symbol}${amount}`,
						side: "bottom",
						delayMs: 500,
